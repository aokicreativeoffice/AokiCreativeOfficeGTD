...
承知いたしました。提案した**歴史ドメイン用Ontology**（Actor, Event, Structure, Concept）と、`Relation Types.md` のリレーション定義を組み込み、さらに以前の分析内容を整理・集約した「決定版」のマークダウンを作成しました。

この構成では、事件を単なる点ではなく、**「構造（Structure）」と「主体（Actor）」が交差する「動的な結節点」**として記述しています。

---

### ファイル名提案

`1870-Ems-Dispatch-Incident.md`
...
- 2026-03-07: 歴史ドメインOntologyに基づき再構成。